...
public class ListeReclamationForm extends BaseForm{
    ...
    public ListeReclamationForm(Resources res ) {
        ...
        setTitle("Afficher Reclamations");
        ...
        RadioButton partage = RadioButton.createToggle("Liste Rec", barGroup);
        ...
        ArrayList<Reclamation>list = ServicesReclamtion.getInstance().affichageReclamations();
    ...
    private void addButton(Image img,Reclamation rec , Resources res) {
        ...
        Label  descriptionTxt= new Label("etat : "+rec.getEtat(),"NewsTopLine2" );
        Label  referenceTxt= new Label("recReference : "+rec.getReference(),"NewsTopLine2" );
        Label  dateTxt= new Label("date : "+rec.getDate(),"NewsTopLine2" );
