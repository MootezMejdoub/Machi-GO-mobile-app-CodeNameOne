...
public class ListUsersForm extends BaseForm {
    ...
    public ListUsersForm(Resources res ) {
     ...
     //   System.out.println("user connecté email ="+ SessionManager.getEmail());
        ...
        ArrayList<Utilisateur>list = ServiceUser.getInstance().afficheUsers();
    ...
    private void addButton(Image img,Utilisateur rec , Resources res) {
        ...
        Label objetTxt = new Label("Date : "+rec.getNom(),"NewsTopLine2");
        Label dateTxt = new Label("objet : "+rec.getEmail(),"NewsTopLine2");
        Label prenomTxt = new Label("etat : "+rec.getPrenom(),"NewsTopLine2" );
