...
import static com.mycompany.services.ServicesReclamtion.countAtt;
...
BaseForm form;
        ...
        RadioButton ajouter = RadioButton.createToggle("Reclamer", barGroup);
        ...
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(3, stats,liste ,ajouter),
  ...
  ;       
    ...
    public void createPieChartForm() {
        ...
        //values
        ServicesReclamtion.getInstance().affichageReclamations();
        
        double enAttente = ServicesReclamtion.countAtt;
        
        double traité = ServicesReclamtion.countTraite;
        total=enAttente+traité;
        ...
        //CREATe the chart ...
        PieChart chart = new PieChart(buildDataset("title",Math.round(enAttente),Math.round(traité)), renderer);
    ...
    private CategorySeries buildDataset(String title, double prcntFeed, double prcntRec) {
        ...
        series.add("Traité",prcntRec);
        series.add("En Attente",prcntFeed);
